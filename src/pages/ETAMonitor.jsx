...
import ETAMonitorDashboard from "../components/admin/ETAMonitorDashboard";
import { AlertTriangle } from "lucide-react";

export default function ETAMonitor() {
  ...
  const { data: operator } = useQuery({
    queryKey: ['eta-operator', user?.email],
    queryFn: async () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">ETA Monitoring & Route Optimization</h1>
          <p className="text-gray-400">Real-time traffic analysis and automatic passenger notifications</p>
        </div>
