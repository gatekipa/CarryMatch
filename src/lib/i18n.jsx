...
const translations = {
  en: {
    ...
    shipmentList: {
      title: "Shipments",
      description: "Browse and manage all your shipments.",
      searchPlaceholder: "Search by tracking #, name, or phone...",
      filterStatus: "Status",
      filterPayment: "Payment",
      filterAll: "All",
      newShipment: "New shipment",
      emptyTitle: "No shipments found",
      emptyBody: "No shipments match your current filters, or you have not created any yet.",
      showing: "Showing",
      of: "of",
      prev: "Previous",
      next: "Next",
      ...
      statuses: {
        ...
        arrived: "Arrived",
        ready_for_pickup: "Ready for pickup",
        out_for_last_mile_delivery: "Out for delivery",
        collected: "Collected",
        returned: "Returned",
        cancelled: "Cancelled",
      },
    ...
    customerList: {
      ...
      searchPlaceholder: "Search by phone, name, or email...",
      emptyTitle: "No customers found",
      emptyBody: "Customers are created automatically when you process shipments.",
      showing: "Showing",
      of: "of",
      prev: "Previous",
      next: "Next",
    ...
    customerDetail: {
      ...
      shipmentsDescription: "All shipments involving this customer as sender or receiver.",
      noShipments: "No shipments found for this customer.",
      notFound: "Customer not found",
      notFoundBody: "This customer record does not exist or you do not have access.",
      ...
      roleBoth: "Sender & Receiver",
    },
    admin: {
      title: "Admin dashboard",
      description: "Review and manage vendor partner applications from this admin panel.",
      loggedInAs: "Logged in as",
      noAccessTitle: "Admin access required",
      noAccessBody: "You do not have admin privileges to access this page.",
      loadFailed: "We could not load the applications right now.",
      filterAll: "All",
      filter_pending: "Pending",
      filter_info_requested: "Info requested",
      filter_approved: "Approved",
      filter_rejected: "Rejected",
      emptyTitle: "No applications found",
      emptyBody: "There are no vendor applications matching this filter.",
      unnamedCompany: "Unnamed company",
      approveBtn: "Approve",
      rejectBtn: "Reject",
      requestInfoBtn: "Request info",
      confirmApprove: "Are you sure you want to approve this application? A vendor record will be created.",
      confirmReject: "Provide a rejection reason before rejecting this application.",
      confirmRequestInfo: "Are you sure you want to request more information from this applicant?",
      ...
      cancelAction: "Cancel",
      approveSuccess: "Application approved and vendor record created.",
      rejectSuccess: "Application rejected.",
      requestInfoSuccess: "Information request sent to applicant.",
      actionFailed: "The action could not be completed right now.",
    },
    subscription: {
      title: "Subscription",
      description: "Manage your plan and activate coupon codes to unlock Pro features.",
      noVendorTitle: "Vendor record not available",
      noVendorBody: "We could not find the active vendor record needed for subscription management.",
      loadFailed: "We could not load your subscription status right now.",
      currentPlanTitle: "Current plan",
      expired: "Expired",
      expiresLabel: "Expires",
      sourceLabel: "Source",
      planNow: "Plan",
      couponTitle: "Activate a coupon code",
      couponDescription: "If you have a coupon code, enter it below to upgrade your plan.",
      couponPlaceholder: "Enter coupon code",
      activateBtn: "Activate",
      couponActivated: "Coupon activated successfully.",
      couponFailed: "We could not activate this coupon code.",
      comparisonTitle: "Feature comparison",
      featureColumn: "Feature",
      freeColumn: "Free",
      proColumn: "Pro",
      freeShipmentLimit: "Up to 50/mo",
      proUnlimited: "Unlimited",
      checkMark: "Yes",
      featureShipments: "Shipments per month",
      featureBranches: "Branches",
      featureLabels: "Shipping labels",
      featureBatchPrint: "Batch printing",
      featurePhotoUpload: "Photo upload",
      featureAdvancedReports: "Advanced reports",
      featureImportCustomers: "Customer import",
      stripePlaceholderTitle: "Stripe billing placeholder",
      stripePlaceholderBody: "Online payment and Stripe subscription integration stay for a later slice. Use coupon codes for now.",
    },
    shell: {
  ...
  fr: {
    ...
    shipmentList: {
      title: "Envois",
      description: "Parcourez et gerez tous vos envois.",
      searchPlaceholder: "Rechercher par n\u00b0 de suivi, nom ou telephone...",
      filterStatus: "Statut",
      filterPayment: "Paiement",
      filterAll: "Tous",
      newShipment: "Nouvel envoi",
      emptyTitle: "Aucun envoi trouve",
      emptyBody: "Aucun envoi ne correspond a vos filtres, ou vous n'en avez pas encore cree.",
      showing: "Affichage",
      of: "sur",
      prev: "Precedent",
      next: "Suivant",
      ...
      statuses: {
        ...
        arrived: "Arrive",
        ready_for_pickup: "Pret pour retrait",
        out_for_last_mile_delivery: "En cours de livraison",
        collected: "Retire",
        returned: "Retourne",
        cancelled: "Annule",
      },
    ...
    customerList: {
      title: "Clients",
      description: "Consultez et gerez vos contacts clients.",
      searchPlaceholder: "Rechercher par telephone, nom ou email...",
      emptyTitle: "Aucun client trouve",
      emptyBody: "Les clients sont crees automatiquement lors du traitement des envois.",
      showing: "Affichage",
      of: "sur",
      prev: "Precedent",
      next: "Suivant",
    ...
    customerDetail: {
      ...
      preferredLanguage: "Langue preferee",
      notes: "Notes",
      saveSuccess: "Client mis a jour avec succes.",
      newShipment: "Nouvel envoi",
      shipments: "Historique des envois",
      shipmentsDescription: "Tous les envois impliquant ce client en tant qu'expediteur ou destinataire.",
      noShipments: "Aucun envoi trouve pour ce client.",
      notFound: "Client non trouve",
      notFoundBody: "Ce dossier client n'existe pas ou vous n'y avez pas acces.",
      colTracking: "N\u00b0 de suivi",
      colRole: "Role",
      colRoute: "Itineraire",
      colStatus: "Statut",
      colDate: "Date",
      roleSender: "Expediteur",
      roleReceiver: "Destinataire",
      roleBoth: "Expediteur et destinataire",
    },
    admin: {
      title: "Tableau de bord admin",
      description: "Examinez et gerez les candidatures de partenaires vendeurs depuis ce panneau.",
      loggedInAs: "Connecte en tant que",
      noAccessTitle: "Acces admin requis",
      noAccessBody: "Vous n'avez pas les privileges administrateur pour acceder a cette page.",
      loadFailed: "Impossible de charger les candidatures pour le moment.",
      filterAll: "Toutes",
      filter_pending: "En attente",
      filter_info_requested: "Info demandee",
      filter_approved: "Approuvees",
      filter_rejected: "Rejetees",
      emptyTitle: "Aucune candidature trouvee",
      emptyBody: "Aucune candidature ne correspond a ce filtre.",
      unnamedCompany: "Entreprise sans nom",
      approveBtn: "Approuver",
      rejectBtn: "Rejeter",
      requestInfoBtn: "Demander des infos",
      confirmApprove: "Etes-vous sur de vouloir approuver cette candidature ? Un dossier vendeur sera cree.",
      confirmReject: "Indiquez la raison du rejet avant de rejeter cette candidature.",
      confirmRequestInfo: "Etes-vous sur de vouloir demander plus d'informations a ce candidat ?",
      rejectionReasonLabel: "Raison du rejet",
      rejectionReasonPlaceholder: "Expliquez pourquoi cette candidature est rejetee.",
      rejectionReasonRequired: "Une raison de rejet est requise.",
      confirmAction: "Confirmer",
      cancelAction: "Annuler",
      approveSuccess: "Candidature approuvee et dossier vendeur cree.",
      rejectSuccess: "Candidature rejetee.",
      requestInfoSuccess: "Demande d'informations envoyee au candidat.",
      actionFailed: "L'action n'a pas pu etre completee pour le moment.",
    },
    subscription: {
      title: "Abonnement",
      description: "Gerez votre forfait et activez des codes promo pour debloquer les fonctionnalites Pro.",
      noVendorTitle: "Dossier vendeur non disponible",
      noVendorBody: "Impossible de trouver le dossier vendeur actif necessaire a la gestion de l'abonnement.",
      loadFailed: "Impossible de charger le statut de votre abonnement pour le moment.",
      currentPlanTitle: "Forfait actuel",
      expired: "Expire",
      expiresLabel: "Expiration",
      sourceLabel: "Source",
      planNow: "Forfait",
      couponTitle: "Activer un code promo",
      couponDescription: "Si vous avez un code promo, entrez-le ci-dessous pour mettre a niveau votre forfait.",
      couponPlaceholder: "Entrez le code promo",
      activateBtn: "Activer",
      couponActivated: "Code promo active avec succes.",
      couponFailed: "Impossible d'activer ce code promo.",
      comparisonTitle: "Comparaison des fonctionnalites",
      featureColumn: "Fonctionnalite",
      freeColumn: "Gratuit",
      proColumn: "Pro",
      freeShipmentLimit: "Jusqu'a 50/mois",
      proUnlimited: "Illimite",
      checkMark: "Oui",
      featureShipments: "Envois par mois",
      featureBranches: "Agences",
      featureLabels: "Etiquettes d'expedition",
      featureBatchPrint: "Impression par lot",
      featurePhotoUpload: "Upload de photos",
      featureAdvancedReports: "Rapports avances",
      featureImportCustomers: "Import de clients",
      stripePlaceholderTitle: "Placeholder facturation Stripe",
      stripePlaceholderBody: "Le paiement en ligne et l'integration Stripe restent pour une tranche ulterieure. Utilisez les codes promo pour le moment.",
    },
    shell: {
